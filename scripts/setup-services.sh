...
echo -e "  - ${BLUE}scripts/gemma4${NC}, ${BLUE}scripts/qwen${NC}, ${BLUE}scripts/qwen27b${NC}, ${BLUE}scripts/bonsai${NC}, ${BLUE}scripts/bedrock${NC}, or ${BLUE}scripts/openai${NC} to start the LLM."
