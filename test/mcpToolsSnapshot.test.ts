...
describe('mcp tools snapshot', () => {
  it('keeps stable schema hashes for key tools', async () => {
    ...
    expect(hashes).toEqual({
      ...
      search_knowledge_legacy: '196e07c37903e5b19d6151908b6b87950ec819b89fc04f983b485a0615e02dfe',
      ...
      review_task: '0d061493a0f48e980dc8158fa73d0ef3c7299cecc894e2f7d6b54781c116285c',
