...
Return one phrase per line.
Do not return bullets, numbering, explanations, categories, scores, confidence, URLs, or JSON.
If the context does not contain enough useful programming-related direction, return nothing.
