...
Refer to the global Gnosis manual only when MCP tool policy is unclear: $HOME/.gnosis/agent/manual.md

<!-- gnosis-hooks:start -->
# Gnosis Hook Workflow (Auto-managed)
- Read and follow the hook guide at: $HOME/.gnosis/hooks/manual.md
